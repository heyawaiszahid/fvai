        ...
        <section className="grid grid-cols-1 lg:grid-cols-2 lg:mb-6">
          <div className="overflow-hidden lg:order-2">
            <Image
              ...
              width={709}
              height={664}
              className="w-[393px] lg:w-[709px] -mt-8 lg:-mt-4 mx-auto"
            />
          </div>
          <div className="px-6 -mt-24 lg:mt-0 lg:py-16">
            <div className="text-3xl lg:text-5xl leading-snug lg:leading-tight text-center text-text-secondary mb-3 lg:mb-4">
            ...
            <div className="text-[40px] lg:text-5xl text-center text-text-secondary font-bold mb-4 lg:mb-9">
              $4.3M - $17.6M
            </div>
            <Link
              href="#"
              className="bg-primary block text-2xl text-background-paper text-center font-bold rounded-full p-4 max-w-md mx-auto lg:text-2xl mb-4"
            >
